...
<!--pekes estado de guerra--> 
				<div >
					<form action="guerras.php" method="get" class="botones" >
						...
						<div class="boton"><button  class="bot" name="bienvenida" value="bienvenida"   type="submit"><h1>Bienvenida</h1></button></div>
			...
			?>
				...
				<div id="guerrae">
						...
						<form action="guerras.php" method="get">
							<label for="clan"><h1>Escribe el codigo del clan</h1></br></label>
...
<?php if(isset($datog["clan"]["members"])){ $mienbrospk = $datog["clan"]["members"];}
	if(isset($datog["opponent"]["members"])){ $mienbrospk2 = $datog["opponent"]["members"];} 
			?>
   ...
   <div id="guerrae">
			            <div class="wari" ><!--style="font-family:Arial, Helvetica, sans-serif; font-size:17px;"-->
							<table  >
								<tr class="logo">
									<td style="width:40%; "> <?php  if (isset($datog["clan"]["name"])){ echo $datog["clan"]["name"];} ?></br><img src="<?php  if (isset($datog["clan"]["badgeUrls"]["small"])){ echo $datog["clan"]["badgeUrls"]["small"];} ?>"/>
									</td>
									<td style="font-size:80px;">VS
									</td>
									<td style="width:40%; "> <?php  if (isset($datog["opponent"]["name"])){ echo $datog["opponent"]["name"];} ?></br><img src="<?php  if (isset($datog["opponent"]["badgeUrls"]["small"])){ echo $datog["opponent"]["badgeUrls"]["small"];} ?>"/>
									</td>
								</tr>
							</table>
					...
					<?php	echo	"<table >";
								 if (isset($datog["state"])){ $estadog = $datog["state"];
								    switch ($estadog) {
                                        case "preparation":
                                           echo"<tr ><t style=' font-family: supercell; text-shadow: -1px -1px 0 black, 1px -1px 0 black, -1px 1px 0 black, 1px 1px 0 black; font-size:25px; text-align:center; color:red;  animation-name: parpadeo; animation-duration: 1s; animation-timing-function: linear; animation-iteration-count: infinite;'>Dia de  preparacion</t>
											...
											<tr>
												<td>Participantes ";
												 if(isset($datog["teamSize"])){ echo $datog["teamSize"];} "</td>
											</tr>";
                                            break;
                                        case "inWar":
						...
						<div class="warp">
							...
							<table  >
								<?php if (isset($estadog)&&($estadog=='inWar')){
							 	?>
							 <tr>
									<td colspan="3"><?php if(isset($datog["clan"]["name"])){echo $datog["clan"]["name"];} ?> </td>
								</tr>
								<tr>
									<td  colspan="3" ><img src="<?php if(isset($datog["clan"]["badgeUrls"]["medium"])){echo $datog["clan"]["badgeUrls"]["medium"];} ?>"/><br><br></td>
								</tr >
								<tr class="marcador">
									<td style="float :left;" >estrellas  </td><td><?php if(isset($datog["clan"]["stars"])){ echo $datog["clan"]["stars"];} ?></td>
								</tr>
								<tr class="marcador">
									<td style="float :left;" >Ataques</td><td><?php if(isset($datog["clan"]["attacks"])){ echo $datog["clan"]["attacks"];} ?></td>
								</tr>
								<tr class="marcador">
									<td style="float :left; " >Destruccion</td><td><?php if(isset($datog["clan"]["destructionPercentage"])){ echo $datog["clan"]["destructionPercentage"]."%";} ?></td>
								</tr>
						    <?php } ?>
							</table>
							...
							<table   cellpadding="0">
								...
								<tr colspan="2"  ><td  style="height:183px;  " colspan="2"><?php $star = "starwar";  $star0 = "starwar0"; $star1 = "starwar1"; $star2 = "starwar2"; $star3 = "starwar3";if(isset($mienbropk ["bestOpponentAttack"]["stars"])){$estrellas = $mienbropk["bestOpponentAttack"]["stars"];
										 switch ($estrellas) {
										case "0":
						...
						<div class="warp">
							...
							<table  >
								<?php if (isset($estadog)&&($estadog=='inWar')){
							 	?>
							 <tr>
									<td colspan="3"><?php if(isset($datog["opponent"]["name"])){echo $datog["opponent"]["name"];} ?> </td>
								</tr>
								<tr>
									<td  colspan="3" ><img src="<?php if(isset($datog["opponent"]["badgeUrls"]["medium"])){echo $datog["opponent"]["badgeUrls"]["medium"];} ?>"/><br><br></td>
								</tr >
								<tr class="marcador">
									<td style="float :left;" >estrellas  </td><td><?php if(isset($datog["opponent"]["stars"])){ echo $datog["opponent"]["stars"];} ?></td>
								</tr>
								<tr class="marcador">
									<td style="float :left;" >Ataques</td><td><?php if(isset($datog["opponent"]["attacks"])){ echo $datog["opponent"]["attacks"];} ?></td>
								</tr>
								<tr class="marcador">
									<td style="float :left; " >Destruccion</td><td><?php if(isset($datog["opponent"]["destructionPercentage"])){ echo $datog["opponent"]["destructionPercentage"]."%";} ?></td>
								</tr>
						    <?php } ?>
							</table>
							...
							<table  cellpadding="0">
								...
								<tr colspan="2"  ><td  style="height:183px;  " colspan="2"><?php  $star0 = "starwar0"; $star1 = "starwar1"; $star2 = "starwar2"; $star3 = "starwar3";if(isset($mienbropk2 ["bestOpponentAttack"]["stars"])){$estrellas2 = $mienbropk2 ["bestOpponentAttack"]["stars"];
									    switch ($estrellas2) {
                                        case "1":
                                           echo  '<img src="../images/iconos/'.$star1.'.png" ; />';
                                            break;
