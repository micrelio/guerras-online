							...
							switch ($estadog) {
								case "preparation":
									...
									if (isset($datog["startTime"])) {
										...
										$hiu = substr($fechai, 9, 2); //no se porque va mal ajuste de hora + 19; //sacamos 2 numero para horas
										$him = substr($fechai, 9, 2); //no se porque va mal ajuste de hora+ 18; //sacamos 2 numero para horas
